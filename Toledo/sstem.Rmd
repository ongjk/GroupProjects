...
hist(as.numeric(pass$score), main = "Normal Distribution of Passing Exam Scores", breaks = 10, border = "orange", col = "blue", xlab = "Score", labels = TRUE ) 
```

## Another another random title 
